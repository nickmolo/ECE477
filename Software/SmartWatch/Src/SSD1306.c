...
inline void spiwrite(unsigned char value) {
    ...
    //_spi.write(value);
    HAL_SPI_Transmit_DMA(&hspi3, &value, (uint16_t) 8);
    //HAL_SPI_Transmit(&hspi3, &value, (uint16_t) 8, (uint32_t) 1000);
    //TM_SPI_Send(SPI3, (uint8_t) value);
}
...
void begin(void) {
    ...
    //_spi.frequency(10000000);  <------------ HAL SET SPI SOMEWHERE
